<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="courseInfo2.aspx.cs" Inherits="EN.pages.courseInfo2" %>
     ...
     <!--Add video to the body element-->
      ...
      <div class="jumbotron" id="home">
          <div class="container">
              ...
              <h2>Go from Intermediate-skills to Cash-Earning English Advance</h2>
              <p><a class="btn" href="courseVideos2">Join Now!</a></p>
          </div>
      </div>
