...
namespace EN.pages
{
    public partial class finalExam1 : System.Web.UI.Page
    {
        int result = 0;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (result >= 5)
            {
                ...
                db.SaveChanges();
                //
                string message = "Congrats!!, Your Grade is : " + result.ToString() + ", You will move to Advanced level";
            ...
            else
            {
                ...
                db.SaveChanges();
                //
                string message = "Sorry!!, Your Grade is : " + result.ToString() + ", You will not move to Advanced level";
                System.Text.StringBuilder sb = new System.Text.StringBuilder();
                sb.Append("<script type = 'text/javascript'>");
                sb.Append("window.onload=function(){");
                sb.Append("alert('");
