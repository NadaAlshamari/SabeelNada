<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Elibrary.aspx.cs" Inherits="EN.pages.Elibrary" %>
  ...
  <div class="book-grid">
    <ul>
      ...
      <li> 
          ...
          <a href="<%=item.download_url%>" target="_blank" class="btn btn-success btn-block">Download</a>
