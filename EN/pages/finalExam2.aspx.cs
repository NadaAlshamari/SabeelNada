...
namespace EN.pages
{
    public partial class finalExam2 : System.Web.UI.Page
    {
        int result = 0;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (result >= 5)
            {
                ...
                db.SaveChanges();
                //
                string message = "Congratulations!!!, Your Grade is : " + result.ToString() + ", Now you all levels have been completed";
            ...
            else
            {
                ...
                db.SaveChanges();
                //
                string message = "Sorry!!, Your Grade is : " + result.ToString() + ", This level not completed";
                System.Text.StringBuilder sb = new System.Text.StringBuilder();
                sb.Append("<script type = 'text/javascript'>");
                sb.Append("window.onload=function(){");
                sb.Append("alert('");
