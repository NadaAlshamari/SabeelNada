<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="courseInfo1.aspx.cs" Inherits="EN.pages.courseInfo1" %>
     ...
     <!--Add video to the body element-->
      ...
      <div class="jumbotron" id="home">
          <div class="container">
              ...
              <h2>Go from Basic-skills to Cash-Earning English Intermediate Level</h2>
              <p><a class="btn" href="courseVideos1">Join Now!</a></p>
          </div>
      </div>
