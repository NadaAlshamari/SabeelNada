<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="students.aspx.cs" Inherits="EN.pages.students" %>
...
<!------ Include the above in your HEAD tag ---------->
	...
	<div class="container-fluid bg-full p-0">
        <h1 class=" text-center pt-5 py-4 display-3 text-white">ALL <span class="color1">Students</span></h1>
