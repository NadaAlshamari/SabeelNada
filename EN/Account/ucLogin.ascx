<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucLogin.ascx.cs" Inherits="EN.Account.ucLogin" %>
...
<section>
    <div class="container containerr" id="container">
        ...
        <div class="form-container sign-in-container">
            ...
            <div class="form">
                <h1>Log in</h1>
                <span>Sign in here if you already have an account</span>
                ...
                <asp:Button ID="Button1" runat="server" Text="Log In" class="button active" onclick="Button1_Click" style="margin-top: 9px" />
        ...
        <div class="overlay-container">
            <div class="overlay">
                ...
                <div class="overlay-panel overlay-right">
                    ...
                    <button class="ghost mt-5" id="signIn">Sign Up</button>
                </div>
            </div>
        </div>
    </div>
